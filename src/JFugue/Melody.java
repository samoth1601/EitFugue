    ...
    public Melody (Mood mood, String key, ChordProgression blockProgression,String progressionRoman,String section){
        ...
        for (int i = 0; i < 4; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                int rule1chance = 95;
                if (!haveAdded && i==0 && j==0 && chancePercent(rule1chance)) {
                ...
                if (section.equals("basis")){
                    ...
                    rule3chance=10;
                }if (!haveAdded && chancePercent(rule3chance)) {
                ...
                //Prosent sjanse for at denne regelen intreffer ved dette punktet i koden:
                int rule4chance = 80;
                if (!haveAdded && i>0 && j == 0 && chancePercent(rule4chance)) {
                ...
                if (section.equals("basis")){
                    ...
                    rule5chance=60;
                }if (!haveAdded && i>0 && j==1 && chancePercent(rule5chance)) {
                ...
                //Prosent sjanse for at denne regelen intreffer ved dette punktet i koden:
                int rule2chance = 100;
                if (!haveAdded && chancePercent(rule2chance)) {
